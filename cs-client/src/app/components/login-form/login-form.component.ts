...
export class LoginFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let mySVG = document.querySelector('.svgContainer') as HTMLElement;
    let armL = document.querySelector('.armL');
    let armR = document.querySelector('.armR');
    let eyeL = document.querySelector('.eyeL');
    let eyeR = document.querySelector('.eyeR');
    ...
    function coverEyes() {
      TweenMax.to(armL, .45, { x: -93, y: 2, rotation: 0, ease: Power3.easeOut });
      TweenMax.to(armR, .45, { x: -93, y: 2, rotation: 0, ease: Power3.easeOut, delay: .1 });
    }

    function uncoverEyes() {
      TweenMax.to(armL, 1.35, { y: 220, ease: Power3.easeOut });
      TweenMax.to(armL, 1.35, { rotation: 105, ease: Power3.easeOut, delay: .1 });
      TweenMax.to(armR, 1.35, { y: 220, ease: Power3.easeOut });
      TweenMax.to(armR, 1.35, { rotation: -105, ease: Power3.easeOut, delay: .1 });
    }
